...
var ASM_CONSTS = {
  4530052: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4530107: ($0) => { performance.now = function() { return $0; }; },  
 4530155: ($0) => { performance.now = function() { return $0; }; },  
 4530203: () => { performance.now = Module['emscripten_get_now_backup']; }
};
