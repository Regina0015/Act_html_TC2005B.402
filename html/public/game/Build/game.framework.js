...
var ASM_CONSTS = {
  4529796: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4529851: ($0) => { performance.now = function() { return $0; }; },  
 4529899: ($0) => { performance.now = function() { return $0; }; },  
 4529947: () => { performance.now = Module['emscripten_get_now_backup']; }
};
